...
- [ ] Тайм-аут ASR (180 секунд загрузки / 60 секунд распознавания) показывает
      требование перезапуска, блокирует новую диктовку и отбрасывает поздний
      результат; выход из приложения не ждёт зависший поток распознавания.
